    ...
    <div class="row px-xl-3">
        <div class="col-12">
            <h5 class="title position-relative text-dark text-uppercase mb-3">
                <span class="bg-secondary pe-3">Danh sách nhà cung cấp</span>
            </h5>
            <div class="custom-datatable bg-light p-30 table-responsive">
                <a href="{{ route('admin.supplier.create') }}" type="submit" class="btn btn-primary mb-3">Thêm</a>
                    ...
                    <tbody class="align-middle">
                        ...
                        @forelse ($suppliers as $item)
                            <tr>
                                ...
                                <td>{{ $item['district'] }}</td>
                                <td class="custom">
                                    <a href="{{ route('admin.supplier.update', ['id' => $item['id']]) }}"
